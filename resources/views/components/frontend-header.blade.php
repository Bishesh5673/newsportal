<header>
    <div class="container flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-10 items-center justify-between py-2 ">
        ...
        <div>
            ...
            <img height="10" class="h-[15px] w-[135px]" src="https://jawaaf.com/frontend/images/redline.png" alt="underline">
        </div>
...
<!-- drawer init and toggle -->
 ...
 <!-- drawer component -->
 <div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-var[(--primary-color)] w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label">
    ...
    <button type="button" data-drawer-hide="drawer-example" aria-controls="drawer-example" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 flex items-center justify-center dark:hover:bg-var[(--primary-color)] dark:hover:text-white" >
