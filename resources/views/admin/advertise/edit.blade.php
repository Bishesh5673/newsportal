                ...
                <form action="{{route('admin.advertise.update',$advertise->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-6" >
                            ...
                            <input type="tel" name="contact" id="contact" class="form-control" value="{{$advertise->contact}}">
                            @error('contact')
                                <div class="text-danger">
                                    {{$message}}
                                </div>
                        ...
                        <div class="mb-3 col-6" >
                            ...
                            <input type="date" min="{{ now()->format('y-m-d')}}" name="expire_date" id="expire_date" class="form-control" value="{{$advertise->expire_date}}">
                            @error('expire_date')
                                <div class="text-danger">
                                    {{$message}}
                                </div>
                        ...
                        <div class="mb-3 col-6" >
                            ...
                            <input type="text" name="redirect_url" id="redirect_url" class="form-control" value="{{$advertise->redirect_url}}">
                            @error('redirect_url')
                                <div class="text-danger">
                                    {{$message}}
                                </div>
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input type="file" name="image" id="image" class="form-control" value="{{$advertise->image}}">
                            @error('image')
                                <div class="text-danger">
                                    {{$message}}
                                </div>
